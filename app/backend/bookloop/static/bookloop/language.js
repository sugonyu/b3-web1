...
(function () {
  ...
  const pageTranslations = {
    en: {
      ...
      bookDetailsIntro: "Review the listing before you decide whether to request this book.",
      viewBookDetails: "View details",
      backToBooks: "Back to books",
      bookOwner: "Owner",
      bookNumber: "Book number",
      listed: "Listed",
      requestThisBook: "Request this book",
      viewExistingRequest: "View existing request",
    ...
    ko: {
      ...
      myReports: "내 신고",
      booksPageTitle: "책",
      bookDetailsPageTitle: "책 상세 정보",
      bookDetails: "책 상세 정보",
      bookDetailsIntro: "책을 요청하기 전에 목록 정보를 확인하세요.",
      viewBookDetails: "상세 보기",
      backToBooks: "책 목록으로",
      bookOwner: "소유자",
      bookNumber: "책 번호",
      listed: "등록일",
      requestThisBook: "이 책 요청하기",
      viewExistingRequest: "기존 요청 보기",
    ...
    fr: {
      ...
      bookDetailsPageTitle: "Détails du livre",
      bookDetails: "Détails du livre",
      bookDetailsIntro: "Consultez la fiche avant de décider si vous souhaitez demander ce livre.",
      viewBookDetails: "Voir les détails",
      backToBooks: "Retour aux livres",
      bookOwner: "Propriétaire",
      bookNumber: "Numéro du livre",
      listed: "Publié le",
      requestThisBook: "Demander ce livre",
      viewExistingRequest: "Voir la demande existante",
